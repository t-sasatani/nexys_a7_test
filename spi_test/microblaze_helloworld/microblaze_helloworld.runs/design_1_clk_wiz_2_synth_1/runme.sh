...
HD_PWD='C:/Users/Takuya/Documents/GitHub/nexys_a7_test/spi_test/microblaze_helloworld/microblaze_helloworld.runs/design_1_clk_wiz_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_clk_wiz_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_clk_wiz_2.tcl
